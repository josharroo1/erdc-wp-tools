...
define('CAC_AUTH_PLUGIN_VERSION', '3.3.4');
...
require_once CAC_AUTH_PLUGIN_DIR . 'includes/cac-auth-virtual-login-page.php';
require_once CAC_AUTH_PLUGIN_DIR . 'includes/cac-auth-login-init.php';
